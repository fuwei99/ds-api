                        ...
                        apiKeys.map((item, i) => (
                            <div key={i} className="p-4 flex items-center justify-between hover:bg-muted/50 transition-colors group">
                                <div className="grid grid-cols-1 md:grid-cols-3 gap-2 flex-1">
                                    ...
                                    {item.force_disable_tools && (
                                        <span className="inline-flex items-center rounded-full px-2 py-0.5 text-xs font-medium w-fit bg-amber-500/15 text-amber-600 dark:text-amber-400">
                                            {t('accountManager.forceDisableToolsOn')}
                                        </span>
                                    )}
                                    {copiedKey === item.key && (
