...
func (r *Runner) caseModelsOpenAI(ctx context.Context, cc *caseContext) error {
	...
	cc.assert("has_deepseek_chat", contains(ids, "deepseek-v4.1-flash"), strings.Join(ids, ","))
	cc.assert("has_deepseek_reasoner", contains(ids, "deepseek-v4.1-flash"), strings.Join(ids, ","))
	cc.assert("has_deepseek_expert_chat", contains(ids, "deepseek-v4.1-flash"), strings.Join(ids, ","))
	cc.assert("has_deepseek_expert_reasoner", contains(ids, "deepseek-v4.1-flash"), strings.Join(ids, ","))
	cc.assert("has_deepseek_vision_chat", contains(ids, "deepseek-v4.1-flash"), strings.Join(ids, ","))
	cc.assert("has_deepseek_vision_reasoner", contains(ids, "deepseek-v4.1-flash"), strings.Join(ids, ","))
	return nil
}
...
func (r *Runner) caseModelOpenAIByID(ctx context.Context, cc *caseContext) error {
	...
	cc.assert("id_deepseek_chat", asString(m["id"]) == "deepseek-v4.1-flash", fmt.Sprintf("body=%s", string(resp.Body)))
	return nil
}
