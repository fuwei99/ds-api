...
func (managedFilesAuthStub) ForceDisableToolsForRequest(_ *http.Request) bool { return false }
...
func TestFilesRouteUploadSuccess(t *testing.T) {
	...
	req := newMultipartUploadRequest(t, "assistants", "notes.txt", []byte("hello world"), "deepseek-v4.1-flash")
