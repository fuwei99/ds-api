...
func TestHandleResponsesStreamEmitsReasoningTextDeltaEvents(t *testing.T) {
	...
	h.handleResponsesStream(rec, req, resp, "owner-a", "resp_test", "deepseek-v4.1-flash", "prompt", 0, true, false, nil, nil, promptcompat.DefaultToolChoicePolicy(), "")
...
func TestHandleResponsesStreamEmitsOutputTextDoneBeforeContentPartDone(t *testing.T) {
	...
	h.handleResponsesStream(rec, req, resp, "owner-a", "resp_test", "deepseek-v4.1-flash", "prompt", 0, false, false, nil, nil, promptcompat.DefaultToolChoicePolicy(), "")
	body := rec.Body.String()
...
func TestHandleResponsesStreamReasoningTextDeltaCarriesItemIndexes(t *testing.T) {
	...
	h.handleResponsesStream(rec, req, resp, "owner-a", "resp_reasoning_idx", "deepseek-v4.1-flash", "prompt", 0, true, false, nil, nil, promptcompat.DefaultToolChoicePolicy(), "")
	body := rec.Body.String()
...
func TestHandleResponsesStreamClosesReasoningBeforeMessageStarts(t *testing.T) {
	...
	h.handleResponsesStream(rec, req, resp, "owner-a", "resp_reasoning_order", "deepseek-v4.1-flash", "prompt", 0, true, false, nil, nil, promptcompat.DefaultToolChoicePolicy(), "")
...
func TestHandleResponsesStreamCoalescesSmallOutputTextDeltas(t *testing.T) {
	...
	h.handleResponsesStream(rec, req, resp, "owner-a", "resp_coalesce", "deepseek-v4.1-flash", "prompt", 0, false, false, nil, nil, promptcompat.DefaultToolChoicePolicy(), "")
...
func TestHandleResponsesStreamEmitsDistinctToolCallIDsAcrossSeparateToolBlocks(t *testing.T) {
	...
	h.handleResponsesStream(rec, req, resp, "owner-a", "resp_test", "deepseek-v4.1-flash", "prompt", 0, false, false, []string{"read_file", "search"}, nil, promptcompat.DefaultToolChoicePolicy(), "")
...
func TestHandleResponsesStreamDropsTextAfterToolCallBlock(t *testing.T) {
	...
	h.handleResponsesStream(rec, req, resp, "owner-a", "resp_test", "deepseek-v4.1-flash", "prompt", 0, false, false, []string{"read_file"}, nil, promptcompat.DefaultToolChoicePolicy(), "")
...
func TestResponsesRetryRuntimeAlwaysBuffersToolContent(t *testing.T) {
	...
	streamRuntime, _, ok := h.prepareResponsesStreamRuntime(rec, resp, "owner-a", "resp-retry-test", "deepseek-v4.1-flash", "prompt", 0, false, false, nil, nil, promptcompat.DefaultToolChoicePolicy(), "", nil)
	if !ok {
...
func TestHandleResponsesStreamRequiredToolChoiceFailure(t *testing.T) {
	...
	h.handleResponsesStream(rec, req, resp, "owner-a", "resp_test", "deepseek-v4.1-flash", "prompt", 0, false, false, []string{"read_file"}, nil, policy, "")
...
func TestHandleResponsesStreamPromotesThinkingToolCallsOnFinalizeWithoutMidstreamIntercept(t *testing.T) {
	...
	h.handleResponsesStream(rec, req, resp, "owner-a", "resp_test", "deepseek-v4.1-flash", "prompt", 0, true, false, []string{"read_file"}, nil, promptcompat.DefaultToolChoicePolicy(), "")
...
func TestHandleResponsesStreamPromotesHiddenThinkingEPSEToolCallsOnFinalize(t *testing.T) {
	...
	h.handleResponsesStream(rec, req, resp, "owner-a", "resp_hidden", "deepseek-v4.1-flash", "prompt", 0, false, false, []string{"read_file"}, nil, policy, "")
...
func TestHandleResponsesNonStreamRequiredToolChoiceViolation(t *testing.T) {
	...
	h.handleResponsesNonStream(rec, resp, "owner-a", "resp_test", "deepseek-v4.1-flash", "prompt", 0, false, false, []string{"read_file"}, nil, policy, "")
...
func TestHandleResponsesNonStreamRequiredToolChoiceIgnoresThinkingToolPayloadWhenTextExists(t *testing.T) {
	...
	h.handleResponsesNonStream(rec, resp, "owner-a", "resp_test", "deepseek-v4.1-flash", "prompt", 0, true, false, []string{"read_file"}, nil, policy, "")
	if rec.Code != http.StatusUnprocessableEntity {
		t.Fatalf("expected 422 for required tool_choice violation, got %d body=%s", rec.Code, rec.Body.String())
	}
	out := decodeJSONBody(t, rec.Body.String())
...
func TestHandleResponsesNonStreamSingleAttemptReturns503WhenUpstreamOutputEmpty(t *testing.T) {
	...
	h.handleResponsesNonStream(rec, resp, "owner-a", "resp_test", "deepseek-v4.1-flash", "prompt", 0, false, false, nil, nil, promptcompat.DefaultToolChoicePolicy(), "")
...
func TestHandleResponsesNonStreamSingleAttemptReturns429WhenUpstreamHasOnlyThinking(t *testing.T) {
	...
	h.handleResponsesNonStream(rec, resp, "owner-a", "resp_test", "deepseek-v4.1-flash", "prompt", 0, true, false, nil, nil, promptcompat.DefaultToolChoicePolicy(), "")
...
func TestHandleResponsesNonStreamPromotesThinkingToolCallsWhenTextEmpty(t *testing.T) {
	...
	h.handleResponsesNonStream(rec, resp, "owner-a", "resp_test", "deepseek-v4.1-flash", "prompt", 0, true, false, []string{"read_file"}, nil, promptcompat.DefaultToolChoicePolicy(), "")
...
func TestHandleResponsesNonStreamPromotesHiddenThinkingEPSEToolCallsWhenTextEmpty(t *testing.T) {
	...
	h.handleResponsesNonStream(rec, resp, "owner-a", "resp_hidden", "deepseek-v4.1-flash", "prompt", 0, false, false, []string{"read_file"}, nil, policy, "")
	if rec.Code != http.StatusOK {
...
func TestHandleResponsesStreamCoercesSchemaDeclaredStringArguments(t *testing.T) {
	...
	h.handleResponsesStream(rec, req, resp, "owner-a", "resp_string_protect", "deepseek-v4.1-flash", "prompt", 0, false, false, []string{"Write"}, toolsRaw, promptcompat.DefaultToolChoicePolicy(), "")
